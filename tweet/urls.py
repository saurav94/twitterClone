...
urlpatterns = [
    ...
    path('user/<str:username>/',
         views.UserTweetListView.as_view(), name='user-tweets'),
    ...
    path('tweet/<int:pk>/update/',
         views.TweetUpdateView.as_view(), name='tweet-update'),
    path('tweet/<int:pk>/delete/',
         views.TweetDeleteView.as_view(), name='tweet-delete'),
