...
function followUser(user) {
  $.ajax({
    ...
    success: function (data) {
      ...
      var following = data.following + ' Following';
      $('.followdetails span:first-child').text(followers);
      $('.followdetails span:last-child').text(following);
